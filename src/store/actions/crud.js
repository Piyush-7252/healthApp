import {
  ...
  clearStoreData as clearStoreDataFunc,
} from './helper';
...
export const REQUEST_CREATE_WITH_DEBOUNCE =
  '@crud/REQUEST_CREATE_WITH_DEBOUNCE';
...
export const setFilterData = (id, filtersData, type) => ({
...
export const requestCreateWithDebounce = requestCreateFunc(
...
export const clearStoreData = clearStoreDataFunc(CLEAR_STORE);
